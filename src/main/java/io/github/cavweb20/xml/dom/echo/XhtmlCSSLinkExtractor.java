...
import io.github.cavweb20.xml.dom.echo.filters.XhtmlCSSLinkNodeFilter;
...
public class XhtmlCSSLinkExtractor
{
    ...
    private static final Logger LOG = LoggerFactory.getLogger(XhtmlCSSLinkExtractor.class);
