...
public class EventReportDriver1
{
    ...
    private static Logger LOG = LoggerFactory.getLogger(EventReportDriver1.class);
    ...
    public static void main(String[] args)
    {
        ...
        if (args.length <= 0)
        {
            if (LOG.isInfoEnabled())
                LOG.info("Usage: java EventReportDriver1 URL");
            return;
        }
        ...
        try
        {
            ...
            parser.setContentHandler(new EventReport1());
            parser.setFeature(
