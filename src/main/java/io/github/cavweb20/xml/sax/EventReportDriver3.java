 ...
 * @since  2004-05-15 
 */
public class EventReportDriver3
{

    // Setting up the logging properties
    private static Logger LOG = LoggerFactory.getLogger(EventReportDriver3.class);
    ...
    public static void main(String[] args)
    {
        ...
        if (args.length <= 0)
        {
            if (LOG.isInfoEnabled()) LOG.info("Usage: java EventReportDriver3 URL");
            return;
        }
        ...
        try
        {
            ...
            parser.setContentHandler(new EventReport3());
            parser.setFeature(
